  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 relative flex items-end justify-center">
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Frontend Developer passionate about crafting visually stunning and highly interactive digital experiences. I specialize in blending clean, efficient code with eye-catching animations and intuitive UI/UX design, transforming every project into a dynamic, engaging, and memorable experience. I thrive on pushing the boundaries of creativity while delivering seamless, high-performance interfaces that captivate users.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Using AI as a tool to elevate creativity, not replace the human touch in crafting exceptional digital experiences."
        </blockquote>
      </div>

           <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
  <a href="../../dist\Resume Hamas.pdf" download className="w-full lg:w-auto">
    <button 
      data-aos="fade-up"
      data-aos-duration="800"
